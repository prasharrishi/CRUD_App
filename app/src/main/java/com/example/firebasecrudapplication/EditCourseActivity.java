...
public class EditCourseActivity extends AppCompatActivity {
    ...
    private TextInputEditText courseNameEdt,coursePriceEdt,courseSuitedForEdt,courseImgLinkEdt,courseLinkEdt,courseDescEdt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_course_acitivity);
        ...
        if(courseRVModal!=null){
            ...
            courseImgLinkEdt.setText(courseRVModal.getCourseImg());
